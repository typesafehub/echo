...
import com.typesafe.atmos.trace.{ DefaultActorSystemTracer, Tracer }
...
abstract class AtmosTraceSpec(config: Config = AtmosTraceSpec.config) extends CotestSyncSpec with MustMatchers with BeforeAndAfterAll with BeforeAndAfterEach {
