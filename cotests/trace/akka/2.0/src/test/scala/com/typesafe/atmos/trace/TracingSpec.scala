...
import com.typesafe.atmos.test.{ AtmosTraceSpec, CotestSyncSpec }
...
class Akka20TracingSpec extends AtmosTraceSpec {
  ...
  "Tracing" must {
    ...
    "store all trace events in memory" in {
      ...
      // 82 events: 1 marker, 3 system.actorOf
