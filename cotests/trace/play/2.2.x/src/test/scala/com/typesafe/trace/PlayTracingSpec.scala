...
class Play22IterateeTracingSpec extends ActionTraceSpec {
...
class Play22NettyGetTracingSpec extends ActionTraceNettySpec {
...
class Play22NettyPostTracingSpec extends ActionTraceNettySpec {
...
class Play22NettySamplingTracingSpec extends ActionTraceNettySpec {
