...
object TestApplication {
  ...
  val application: FakeApplication = {
    val r = FakeApplication(additionalConfiguration = Map("application.router" -> "com.typesafe.atmos.trace.TestApplication$Routes",
      "application.secret" -> "tbWgMhvWQ?mIxxjV^VQ6o4@rU2sfChxV`=B63HKJtS>W3OQMe9wNljXUef3^cQ`r",
      "logger.root" -> "OFF",
      "logger.play" -> "OFF",
      "logger.application" -> "OFF",
      "play" -> Map(
        "akka.loggers" -> Seq("com.typesafe.atmos.test.TestLogger"),
