...
class Play23Scala211IterateeTracingSpec extends ActionTraceSpec {
...
class Play23Scala211NettyGetTracingSpec extends ActionTraceNettySpec {
...
class Play23Scala211NettyPostTracingSpec extends ActionTraceNettySpec {
...
class Play23Scala211NettySamplingTracingSpec extends ActionTraceNettySpec {
  import Play23ScalaFakeApp._
