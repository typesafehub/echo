...
import com.typesafe.atmos.trace.TraceProtocol._
...
object ProtobufConverter {
  ...
  private[util] def toProtoSystemMessage(message: SysMsg, builder: com.typesafe.atmos.trace.TraceProtocol.ProtoAnnotationData.Builder) = message match {
    case CreateSysMsg ⇒
