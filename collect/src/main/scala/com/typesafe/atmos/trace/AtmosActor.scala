...
import com.typesafe.atmos.util.OnDemand
...
object AtmosActor {
  ...
  val RemoteHandlerName = "com.typesafe.atmos.trace.store.remote.RemoteTraceEventListener"
  val MongoHandlerName = "com.typesafe.atmos.trace.store.mongo.MongoTraceEventListener"

  private val counter = new AtomicInteger(0)

  private val config = {
    import scala.collection.JavaConverters._
    val appConfig = ConfigFactory.load(akka.atmos.Private.findClassLoader())
